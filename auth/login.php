    ...
    if ($result && mysqli_num_rows($result) == 1) {
        ...
        if (password_verify($pass, $user['pass'])) {
            ...
            if ($user['estado'] == 0) {
                ...
                // Se o estado for 1, o login prossegue normalmente
...
<body class="bg-gradient-to-br from-white from-10% via-[#f5f5f0] via-50% to-[#c8c8b2] to-90% min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md bg-white rounded-3xl shadow-xl overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-[#d8d8c8] to-[#c8c8b2] p-8 text-center text-[#707070] relative cursor-pointer">
            <a onclick="history.back();" class="absolute top-4 left-4 w-10 h-10 bg-gradient-to-br from-[#a8a892] to-[#989882] rounded-full flex items-center justify-center hover:from-[#989882] hover:to-[#a8a892] transition duration-300 shadow-lg text-white">
        ...
        <div class="p-9">
            ...
            <div class="flex justify-center">
                <a href="registo.php" class="w-3/5 border-2 border-[#d8d8c8] text-[#707070] font-semibold py-2 rounded-xl hover:bg-[#c8c8b2] hover:text-[#707070] transition duration-300 text-sm text-center flex items-center justify-center">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
